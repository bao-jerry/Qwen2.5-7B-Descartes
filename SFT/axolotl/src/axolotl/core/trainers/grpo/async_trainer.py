...
This checkout was used with TRL 1.8.0 and Transformers 5.14.1. The narrow
project compatibility adjustments are documented in GRPO/RUNPOD_STARTUP.md.
...
class AsyncGRPOTrainer(GRPOTrainer):
    ...
    def _get_per_token_logps_and_entropies(
        ...
        # TRL 1.8 adds an auxiliary-loss return slot for MoE models. This
        # project trains dense Qwen2.5, so no auxiliary load-balancing loss
        # exists and the compatible value is None.
